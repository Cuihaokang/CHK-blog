            ...
            <div class="z-comments">
              @foreach ($comments as $comment)
                ...
                <p class="z-info">
                  ...
                  <span data-toggle="modal" data-target="#commentModal" data-replyid="{{ $comment->id }}" data-replyname="{{ $comment->name }}" class="glyphicon glyphicon-share-alt" style="float:right;font-size:16px">
                  </span>
                </p>
                <div class="" style="margin-left:40px">
                  @foreach( $comment->replys as $reply )
                    @if( $reply->user_id == 1 )
                      ...
                      <p class="z-name z-center-vertical">Cui Haokang <span class="label label-info z-label">作 者</span></p>
